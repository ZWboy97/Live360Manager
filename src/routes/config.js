export default {
    menus: [ // 菜单相关路由
        { key: '/app/dashboard/index', title: '直播信息统计', icon: 'mobile', component: 'Dashboard' },
        { key: '/app/animation', title: '直播流管理', icon: 'rocket', component: 'StreamsManager' },
        ...
        { key: '/app/cssModule', title: '直播服务管理', icon: 'star', component: 'Cssmodule' },
        {
